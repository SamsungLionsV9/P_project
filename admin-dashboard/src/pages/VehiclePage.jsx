  ...
  const loadVehicles = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `http://localhost:8001/api/admin/vehicles?${params}`
      );
      ...
      const statsRes = await fetch(
        "http://localhost:8001/api/admin/vehicle-stats"
      );
            ...
            <div className="detail-section">
              ...
              <div className="detail-options-grid">
                <label className="checkbox-row">
                  <input
                    type="checkbox"
                    checked={!!selectedVehicle.options?.sunroof}
                    readOnly
                  />
                  <span>선루프</span>
                </label>
                <label className="checkbox-row">
                  <input
                    type="checkbox"
                    checked={!!selectedVehicle.options?.navigation}
                    readOnly
                  />
                  <span>내비게이션</span>
                </label>
                <label className="checkbox-row">
                  <input
                    type="checkbox"
                    checked={!!selectedVehicle.options?.leather_seat}
                    readOnly
                  />
                  <span>가죽시트</span>
                </label>
                <label className="checkbox-row">
                  <input
                    type="checkbox"
                    checked={!!selectedVehicle.options?.smart_key}
                    readOnly
                  />
                  <span>스마트키</span>
                </label>
                <label className="checkbox-row">
                  <input
                    type="checkbox"
                    checked={!!selectedVehicle.options?.rear_camera}
                    readOnly
                  />
                  <span>후방카메라</span>
                </label>
                <label className="checkbox-row">
                  <input
                    type="checkbox"
                    checked={!!selectedVehicle.options?.heated_seat}
                    readOnly
                  />
                  <span>열선시트</span>
                </label>
