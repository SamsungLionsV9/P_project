...
class PredictRequest(BaseModel):
    ...
    # 옵션 정보 (선택)
    has_sunroof: Optional[bool] = Field(None, description="선루프 여부")
    has_navigation: Optional[bool] = Field(None, description="네비게이션 여부")
    has_leather_seat: Optional[bool] = Field(None, description="가죽시트 여부")
    has_smart_key: Optional[bool] = Field(None, description="스마트키 여부")
    has_rear_camera: Optional[bool] = Field(None, description="후방카메라 여부")
    has_led_lamp: Optional[bool] = Field(None, description="LED 램프 여부")
    has_heated_seat: Optional[bool] = Field(None, description="열선시트 여부")
    has_ventilated_seat: Optional[bool] = Field(None, description="통풍시트 여부")
...
class AlertRequest(BaseModel):
    ...
    target_price: int = Field(..., description="목표 가격 (만원)")
    alert_type: str = Field("below", description="알림 타입: below/above/any")
