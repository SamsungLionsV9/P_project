...
class CarImageMapper {
  ...
  static const Map<String, String> _existingImages = {
    ...
    'EV3': 'png', 'EV4': 'png', 'EV5': 'png', 'EV6': 'png', 'EV9': 'png',
    'PV5': 'png',
    '모닝': 'png', '레이': 'png', '니로': 'png', '셀토스': 'png', '쏘렌토': 'png',
    '스토닉': 'png', '쏘울': 'png', '스팅어': 'png',
    '포르테': 'png', '카렌스': 'png', '프라이드': 'png', '스펙트라': 'png', '엔터프라이즈': 'png',
    '타스만': 'png',
    '카스타': 'png', '엘란': 'png', '비스토': 'png', '캐피탈': 'png',
    '그랜드 카니발': 'png', '카니발 II': 'png',
    '기아 스포티지': 'jpg',
    // 현대
    '그랜저': 'png', '쏘나타': 'png', '아반떼': 'png', '투싼': 'png', '싼타페': 'png',
    '스타리아': 'png', '스타렉스': 'png',
    '아이오닉': 'png', '베리타스': 'png', '슈퍼살롱': 'png',
    '뉴 다마스': 'png', '다마스 II': 'png', '라보': 'png', '포텐샤': 'png', '에스페로': 'png',
    '스테이츠맨': 'png',
    '현대 코나': 'jpg', '현대 팰리세이드': 'jpg', '현대 베뉴': 'jpg', '현대 벨로스터': 'jpg',
    '현대 캐스퍼': 'jpg',
    // 제네시스
    'G70': 'png', 'G80': 'png', 'G90': 'png', 'G2X': 'png', 'GV60': 'png',
    'GV70': 'png', 'GV80': 'png',
    // 르노코리아
    'SM3': 'png', 'SM5': 'png', 'SM6': 'png', 'SM7': 'png', 'QM3': 'png',
    'QM5': 'png', 'QM6': 'png', 'XM3': 'png',
    '클리오': 'png', '조에': 'png', '캡처': 'png', '마스터': 'png', '그랑 콜레오스': 'png',
    '아르카나': 'png',
    // 쉐보레/GM
    '스파크': 'png', '크루즈': 'png', '말리부': 'png', '임팔라': 'png', '트랙스': 'png',
    '이쿼녹스': 'png',
    '트래버스': 'png', '볼트': 'png', '캡티바': 'png', '울란도': 'png', '토스카': 'png',
    '콜로라도': 'png',
    '타호': 'png', '아카디아': 'png', '카마로': 'png', '라세티 프리미어': 'png', '젠트라': 'png',
    '알페온': 'png',
    '마티즈 클래식': 'png', '아베오 세단': 'png', '아베오 해치백': 'png', '윈스톰': 'png',
    '크레도스': 'png', '리갈': 'png',
    // 쌍용/KG
    ...
    // 폭스바겐
    '골프': 'png', '아테온': 'png', '제타': 'png', '티구안': 'png', '파사트': 'png',
    'ID': 'png',
    // 토요타
    ...
    '사이버트럭': 'jpg',
    // 페라리
    '페라리 296': 'jpg', '페라리 488': 'jpg', '페라리 F8': 'jpg', '페라리 SF90': 'jpg',
    '페라리 로마': 'jpg',
    // 포드
  ...
  static const Map<String, String> _partialToImage = {
    ...
    '투싼': '투싼',
    '싼타페': '싼타페',
    '팰리세이드': '현대 팰리세이드', // 실제 이미지로 변경
    '코나': '현대 코나', // 실제 이미지로 변경
    '캐스퍼': '현대 캐스퍼', // 실제 이미지로 변경
    '베뉴': '현대 베뉴', // 실제 이미지로 변경
    '벨로스터': '현대 벨로스터', // 실제 이미지로 변경
    '스타리아': '스타리아',
    '스타렉스': '스타렉스',
    '아이오닉': '아이오닉',
    ...
    'EV3': 'EV3', 'EV4': 'EV4', 'EV5': 'EV5', 'EV6': 'EV6', 'EV9': 'EV9',
    'PV5': 'PV5',
    // 제네시스
    ...
    'G-클래스': '벤츠 G-클래스', 'GLA': '벤츠 GLA', 'GLB': '벤츠 GLB',
    '스프린터': '벤츠 스프린터', 'EQA': '벤츠 EQ시리즈', 'EQB': '벤츠 EQ시리즈',
    'EQC': '벤츠 EQ시리즈', 'EQE': '벤츠 EQ시리즈', 'EQS': '벤츠 EQ시리즈',
    // BMW
    '3시리즈': 'BMW 3시리즈', '5시리즈': 'BMW 5시리즈', '7시리즈': 'BMW 7시리즈',
    'X3': 'X3', 'X5': 'X5', 'X6': 'X6', 'X7': 'X7',
    'i3': 'i3', 'i4': 'i4', 'i5': 'i5', 'i7': 'i7', 'iX1': 'iX1', 'iX3': 'iX3',
    'iX': 'iX3',
    // 아우디
    'A4': 'A4', 'A6': 'A6', 'A7': 'A7', 'A8': 'A8',
    'Q5': 'Q5', 'Q7': 'Q7', 'Q8': 'Q8', 'e-tron': 'E-트론', 'E-트론': 'E-트론',
    'e트론': 'E-트론',
    // 렉서스
    ...
    // 지프
    '그랜드 체로키': '지프 그랜드 체로키', '랭글러': '지프 랭글러', '레니게이드': '지프 레니게이드',
    '체로키': '지프 체로키',
    // 캐딜락
    ...
    '모델 3': '테슬라 모델3', '모델 S': '테슬라 모델S', '모델 X': '테슬라 모델X',
    '모델 Y': '테슬라 모델Y', // 공백 포함 버전
    'Model3': '테슬라 모델3', 'ModelS': '테슬라 모델S', 'ModelX': '테슬라 모델X',
    'ModelY': '테슬라 모델Y',
    'Model 3': '테슬라 모델3', 'Model S': '테슬라 모델S', 'Model X': '테슬라 모델X',
    'Model Y': '테슬라 모델Y',
    '사이버트럭': '사이버트럭', 'Cybertruck': '사이버트럭', '테슬라 사이버트럭': '사이버트럭',
    // 페라리
    '296': '페라리 296', '488': '페라리 488', 'F8': '페라리 F8', 'SF90': '페라리 SF90',
    '로마': '페라리 로마',
    '포르토피노': '페라리 로마', '812': '페라리 F8', // 페라리 대표 모델로 매핑
    // 포드
    'F150': '포드 F150', 'F-150': '포드 F150', '머스탱': '포드 머스탱', '브롱코': '포드 브롱코',
    '익스플로러': '포드 익스플로러',
    '머스탱 마하-E': '포드 머스탱', '에스케이프': '포드 익스플로러',
    // 쉐보레 추가
    '챌린저': '챌린저', '도지 챌린저': '챌린저', '콜벳': '콜벳', '쉐보레 콜벳': '콜벳',
    // 폴스타
    ...
    '아슬란': '그랜저', 'i30': '아반떼', 'i40': '쏘나타',
    // 현대 추가 시리즈 매핑
    '코나 일렉트릭': '현대 코나', '코나 하이브리드': '현대 코나', '더 뉴 코나': '현대 코나',
    '더 뉴 팰리세이드': '현대 팰리세이드', '베뉴 크로스': '현대 베뉴',
    '벨로스터 N': '현대 벨로스터', '캐스퍼 일렉트릭': '현대 캐스퍼',
    // 기아 추가 시리즈 매핑
    '스포티지 4세대': '기아 스포티지', '스포티지 5세대': '기아 스포티지', '스포티지 R': '기아 스포티지',
    '올 뉴 스포티지': '기아 스포티지', '더 뉴 스포티지': '기아 스포티지',
  ...
  static String? getImageUrl(String model) {
    ...
    if (imageName == null || extension == null) {
      if (Environment.isDebug) {
        debugPrint(
            '[CarImageMapper] ❌ model="$model" → clean="$cleanModel" → NO IMAGE');
      }
      return null;
    }
    ...
    if (Environment.isDebug) {
      debugPrint(
          '[CarImageMapper] ✅ model="$model" → clean="$cleanModel" → $matchType → $imageName.$extension');
    }
  ...
  static bool hasImage(String model) {
    ...
    // 정확한 매칭
    if (_existingImages.containsKey(cleanModel) ||
        _existingImages.containsKey(model)) {
      return true;
    }
  ...
  static List<String> getMissingImageModels() {
    return [
      ...
      // === BMW ===
      '5시리즈 (G30)', '3시리즈 (G20)', '7시리즈 (G11)', 'X4', '6시리즈 GT', '4시리즈',
      'M 시리즈', 'Z4',
